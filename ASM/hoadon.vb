...
Public Class frmhoadon
    ...
    Private Sub txtthem_Click(sender As Object, e As EventArgs) Handles txtthem.Click
        Try
            ...
            Dim truyvan1 As String = "insert into HoaDon (MaKH,NgaylapHD,MotaHD) Values(N'" + makh + "',N'" + ngaylap + "',N'" + mota + "')"
            thucthi(truyvan1)
    ...
    Private Sub txtsua_Click(sender As Object, e As EventArgs) Handles txtsua.Click
        Try
            ...
            ketnoi.Open()
            Dim sualsp As New SqlCommand("update HoaDon set MaKH = N'" + makh + "', NgaylapHD = '" + ngaylap + "', MotaHD = N'" + mota + "' where MaHD = '" + mahoadon + "'", ketnoi)
